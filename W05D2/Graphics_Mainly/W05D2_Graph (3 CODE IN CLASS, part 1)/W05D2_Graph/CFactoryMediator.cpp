...
const std::string BUNNY_PLY_FILENAME = "bun_zipper_res3.ply";
const std::string TEAPOT_PLY_FILENAME = "Utah_Teapot.ply";
...
// This can olny be called internally
...
unsigned int CFactoryMediator::CreateObjectByType( std::string type, CVector3f initPosition, float initScale )
{
	if ( type == "Bunny" )
	{
		...
		// Created? 
		if ( p_TempObject == 0 ) { return 0; }	// Problem
