...
//#include "CFactoryMediator.h"			// Moved to global.h
...
//int CurrentWidth = 1400;			// Moved to global.h and global.cpp
//int CurrentHeight = 900;
//int WindowHandle = 0;

// Moved to global.h and global.cpp, renamed g_FrameCount
...
//float CubeRotation = 0;			// Not needed anymore

// clock_t is in time.h
//clock_t LastTime = 0;					// Moved to global.h and global.cpp

// All these moved to global.h (and renamed, for the most part)
...
//bool InitWindow(int, char*[]);		// Moved to OpenGL_Initialize.cpp
//bool Initialize(int, char*[]);		// Moved to OpenGL_Initialize.cpp
//bool CreateCube(void);			// Not needed anymore
void LoadShaders(void);
//void DrawCube(void);				//  Moved to global.h and glutDisplay_callback.cpp

// Both of these moved to global.h and global.cpp
...
int main(int argc, char* argv[])
{
	...
	vecModelsToLoad.push_back( "ply/Cube.ply" );
...
// Moved to glutKeyboardSpecial_callbacks.cpp
//void specialKeyCallback( int key, int x, int y )
//{
//	switch ( key )
//	{
...
// Moved to glutKeyboardSpecial_callbacks
...
// Moved to glueReshape_callback.cpp
...
//// Moved to glutClose_callback.cpp
//void DestroyCube()
//{
...
// Moved into the glutDisplay_callback function in glutDisplay_callback.cpp
//void DrawCube(void)
//{
//	// *********************************
//	float CubeAngle;
