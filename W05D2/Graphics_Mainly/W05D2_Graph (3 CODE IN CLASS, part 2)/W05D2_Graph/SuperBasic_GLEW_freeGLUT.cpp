...
int main(int argc, char* argv[])
{
	...
	g_pFactoryMediator->UpdateObjectScaleByID( g_Player_ID, 1.0f / maxExtentBunny );
	//g_pFactoryMediator->UpdateObjectVelocityByID( g_Player_ID, CVector3f( 0.1f, 0.0f, 0.0f ) );

	// Load up the bunnies (or whatever)
	unsigned int ID = g_pFactoryMediator->CreateObjectByType( "Ninja Teapot" );
	...
	g_pFactoryMediator->UpdateObjectScaleByID( ID, 1.0f / maxExtentTeaPot );
	...
	g_pFactoryMediator->UpdateObjectScaleByID( ID, 1.0f / maxExtentBunny );
