...
public:
	...
	virtual unsigned int CreateObjectByType( std::string type, CVector3f initPosition ) = 0;
	virtual unsigned int CreateObjectByType( std::string type, CVector3f initPosition, float initScale ) = 0;
	//
